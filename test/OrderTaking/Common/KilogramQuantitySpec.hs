...
spec = describe "KilogramQuantity" $ do
    describe "Create a unit quantity" $ do
        it "should accept to create unit quantity"
            $ isRight (create "myfieldName" 50.0) `shouldBe` True
        ...
        it "should refuse to create a unit quantity under limits"
            $ create "myfieldName" 0.0 `shouldBe` Left "myfieldName: Must not be less than 5.0e-2"
        it "should refuse to create a unit quantity under limits"
            $ create "myfieldName" 100000.1 `shouldBe` Left "myfieldName: Must not be greater than 100000.0"
